...
private:
    ...
    // tabla que contiene las posiciones en array de los elementos
...
public:
    ...
    IndexPQ(IndexPQ<K, T, Comparator> const&) = default;

    IndexPQ<K, T, Comparator>& operator=(IndexPQ<K, T, Comparator> const&) = default;
