...
COSTE: el coste de cada push o update es de O(logN), e iteramos para leer los datos N veces, siendo N el numero de paises, asi que en el caso peor el coste
total ascenderia a -> O(NlogN)

COSTE EN ESPACIO ADICIONAL: O(N), siendo N el numero de paises
